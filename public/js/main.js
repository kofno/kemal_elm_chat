...
var _user$project$Main$messageList = function (model) {
	var _p0 = model.messages;
	if (_p0.ctor === 'Nothing') {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('You haven\'t received any messages yet!')
				]));
	} else {
		return A2(
			...
			A2(_elm_lang$core$List$map, _user$project$Main$messageRow, _p0._0));
	}
};
var _user$project$Main$callToAction = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$greeting = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('\'Allo!')
		]));
var _user$project$Main$initialModel = function (flags) {
	return {messages: _elm_lang$core$Maybe$Nothing, message: '', config: flags};
};
			...
			case 'Reset':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{messages: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Change':
				return {
			...
			case 'SendMessage':
				return {
					...
					_1: A2(
						...
						_user$project$Main$websocketUrl(model),
						model.message)
				};
			default:
				var _p4 = _p2._0;
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messages: _elm_lang$core$Maybe$Just(messages)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$Main$MessageRecieved = function (a) {
	return {ctor: 'MessageRecieved', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return A2(
		_elm_lang$websocket$WebSocket$listen,
		_user$project$Main$websocketUrl(model),
		_user$project$Main$MessageRecieved);
};
var _user$project$Main$SendMessage = {ctor: 'SendMessage'};
var _user$project$Main$Change = function (a) {
	return {ctor: 'Change', _0: a};
};
var _user$project$Main$messageForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('form-inline'),
				_elm_lang$html$Html_Events$onSubmit(_user$project$Main$SendMessage)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$placeholder('Write a Message!'),
						_elm_lang$html$Html_Events$onInput(_user$project$Main$Change),
						_elm_lang$html$Html_Attributes$value(model.message)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
...
var _user$project$Main$jumboTron = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$greeting,
				_user$project$Main$description,
				_user$project$Main$callToAction,
				_user$project$Main$messageForm(model)
			]));
};
...
var _user$project$Main$resetButton = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Clear Messages')
		]));
var _user$project$Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$jumboTron(model),
				_user$project$Main$resetButton,
				_user$project$Main$messageList(model)
			]));
};
